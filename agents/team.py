#!/usr/bin/env python3
"""Teammate manager (s09/s11) - spawn autonomous teammates with work/idle cycles."""
...
class TeammateManager:
    """Spawn and manage autonomous teammate agents."""
    ...
    def _loop(self, name: str, role: str, prompt: str):
        """Main teammate loop: work phase -> idle phase -> auto-claim or shutdown."""
